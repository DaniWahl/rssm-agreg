...
function showJournalInfo(e, data) {
    ...
    ).innerHTML = `${data.journal_info.journal_no}  ${data.journal_info.transaction_type}`
    dialogEl.querySelector(
        "div > div.modal-content > div.row > div.col > p.journal_date"
    ).innerHTML = `<b>Journal Datum:</b> ${data.journal_info.journal_date}`
    dialogEl.querySelector(
        "div > div.modal-content > div.row > div.col > p.transaction_date"
    ).innerHTML = `<b>Buchungs Datum:</b> ${data.journal_info.booking_date || ""}`
    dialogEl.querySelector(
        "div > div.modal-content > div.row > div.col > p.action"
    ).innerHTML = `<b>${data.journal_info.action}</b>`
    dialogEl.querySelector("div > div.modal-content > div.row > div.col > p.shares").innerHTML = `${shares}`
    dialogEl.querySelector(
        "div > div.modal-content > div.row > div.col > p.person"
    ).innerHTML = `${prep} ${data.journal_info.name} (${data.journal_info.a_code})`
