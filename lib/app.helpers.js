...
module.exports.timestampUTCtoString = timestampUTCtoString
module.exports.dbStringToDate = dbStringToDate
...
function timestampUTCtoString(timestampStr) {
    const date = new Date(timestampStr + " UTC")
    return `${pad0(date.getDate(), 2)}.${pad0(date.getMonth() + 1, 2)}.${date.getFullYear()} ${pad0(
        date.getHours(),
        2
