...
class RSSMShares {
    ...
    async init() {
        ...
        try {
            ...
            fs.access(this.data.config.AG_REGISTER_SIGNATURE_1, fs.constants.F_OK, (err) => {
                this.logError(
                    "signature image file AG_REGISTER_SIGNATURE_1 not found! overriding configuration item to undef"
                )
                this.data.config.AG_REGISTER_SIGNATURE_1 = undefined
            })
            fs.access(this.data.config.AG_REGISTER_SIGNATURE_2, fs.constants.F_OK, (err) => {
                this.logError(
                    "signature image file AG_REGISTER_SIGNATURE_2 not found! overriding configuration item to undef"
                )
                this.data.config.AG_REGISTER_SIGNATURE_2 = undefined
            })
