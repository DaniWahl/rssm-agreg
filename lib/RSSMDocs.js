...
const ag_info = {
    origin : 'Muttenz',
    register : 'Daniel Wahl',
    register_initials : 'DW',
    secretary : 'Ruth Andrea',
    export_path : './exports/'
};
 ...
 * @returns {Promise<any>}
 */
function makeJournalMutation(info) {
    return new Promise((resolve, reject) => {
        ...
        doc.font('Arial Bold')
            ...
            .font('Arial')
            .text('Muttenz,', mm(0), mm(260), formLabel);

        doc.font('Arial Italic')
            .fontSize(8)
            .text('Daniel Wahl', mm(140), mm(269));
 ...
 * @returns {Promise<any>}
 */
function makeJournalTransfer(info) {
    return new Promise((resolve, reject) => {
 ...
 * @returns {Promise<any>}
 */
function makeJournalRepurchase(info) {
    return new Promise((resolve, reject) => {
...
function makeSharesLetter(info) {
    ...
    return new Promise((resolve, reject) => {
        ...
        // Date
        doc.text(ag_info.origin + ', ' + Helpers.dateToString() + '/DW', mm(25))
            .moveDown(3);
