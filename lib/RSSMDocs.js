...
function makeSharesLetterElectronic(info, rssm) {
    ...
    return new Promise(async function (resolve, reject) {
        ...
        doc.text('Wir freuen uns, dass Sie ', cont)
            ...
            .text('Münchenstein gezeichnet haben. Sie haben sich für elektronische Aktien ', cont)
            .text('entschieden, welche nicht in Papierform ausgestellt werden. Eine Auflistung ', cont)
            .text('der Ihnen zugewiesenen Aktien erhalten Sie in der Beilage.')


        doc.moveDown()
            .text('Sie sind als ', mm(25), doc.y, cont)
