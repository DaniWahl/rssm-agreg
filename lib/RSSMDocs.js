...
function makeSharesLetterElectronic(info, rssm) {
    return new Promise(async function (resolve, reject) {
        ...
        doc.text(`${register_admins.admin_1.first_name} ${register_admins.admin_1.first_name}`, cont).text(
            `${register_admins.admin_2.first_name} ${register_admins.admin_2.first_name}`,
            mm(95)
        )
        doc.text("Verwaltungsrat, Aktienregister", cont).text("Verwaltungsrat", mm(92)).moveDown(2)
...
function makeSharesLetter(info, rssm) {
    return new Promise(async function (resolve, reject) {
        ...
        doc.text(`${register_admins.admin_1.first_name} ${register_admins.admin_1.name}`, cont).text(
            `${register_admins.admin_2.first_name} ${register_admins.admin_2.name}`,
            mm(95)
        )
