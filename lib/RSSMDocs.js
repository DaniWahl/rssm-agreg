...
function makeSharesLetterElectronic(info, rssm) {
    return new Promise(async function (resolve, reject) {
        ...
        doc.text(`${register_admins.admin_1.first_name} ${register_admins.admin_1.last_name}`, cont).text(
            `${register_admins.admin_2.first_name} ${register_admins.admin_2.last_name}`,
            mm(92)
        )
