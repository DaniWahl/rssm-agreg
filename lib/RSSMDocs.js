        ...
        if(rssm.data.a_codes[info.a_code]) {    
            ...
            if(rssm.data.a_codes[info.a_code].shares) {
                ...
                for(let i=0; i<rssm.data.a_codes[info.a_code].shares.length; i++) {
                    ...
                    if(is_new) {
                        tableRow([share_no, 'Namenaktie (Stammaktie)', '1000.--'], doc.y, 'new')
                    } else {
                        tableRow([share_no, 'Namenaktie (Stammaktie)', '1000.--'], doc.y, 'normal')
                    } 

                }

                doc.moveDown()
                    .text(`Stand: ${Helpers.dateToString()}`, mm(25))
            }
        }
