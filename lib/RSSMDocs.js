...
function makeJournalMutation(info, rssm) {
    return new Promise(async function (resolve, reject) {
        ...
        doc.font("Arial Italic").fontSize(8).text(ag_register, mm(140), mm(269))
        ...
        doc.fontSize(12).text(info.comment, mm(100), mm(170)).text(Helpers.dateToString(), mm(100), mm(260))
...
function makeSharesLetterElectronic(info, rssm) {
    return new Promise(async function (resolve, reject) {
        ...
        // Date
        doc.fontSize(12)
        doc.text(ag_register_city + ", " + Helpers.dateToString() + "/" + ag_register_init, mm(25)).moveDown(2)
        ...
        doc.text(ag_register, cont).text(ag_signature2, mm(95))
        doc.text("Aktienregister", cont).text("Verwaltungsrat", mm(92)).moveDown(2)
...
function makeSharesLetter(info, rssm) {
    return new Promise(async function (resolve, reject) {
        ...
        // Date
        doc.text(ag_register_city + ", " + Helpers.dateToString() + "/" + ag_register_init, mm(25)).moveDown(3)
